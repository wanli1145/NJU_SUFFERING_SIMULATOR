...
const allCards = [
    // ===== 初始牌 =====
    {id:"init_study", name:"学习", cost:1, type:"study", damage:6, defense:0, gpa:1, image:"images/卡牌-学业/学习.png", desc:"造成6点伤害。"},
    {id:"init_phone", name:"小手机真好玩", cost:1, type:"fun", damage:0, defense:5, gpa:0, image:"images/卡牌-娱乐/小手机真好玩.png", desc:"获得5点效率。"},
    // ===== 学业牌 =====
    {id:"s1", name:"量子速读", cost:1, type:"study", damage:5, defense:0, gpa:3, image:"images/卡牌-学业/量子速读.png", effect:"draw1", desc:"造成5点伤害。抽1张牌。"},
    {id:"s2", name:"考试周", cost:3, type:"study", damage:24, defense:0, gpa:5, image:"images/卡牌-学业/考试周.png", effect:"nextTurnEnergy-1", desc:"造成24点伤害。下回合精力-1。"},
    {id:"s3", name:"记笔记", cost:1, type:"study", damage:0, defense:0, gpa:3, image:"images/卡牌-学业/记笔记.png", effect:"studyDamage+2", desc:"获得2点专注（学业牌伤害+2，本场战斗）。"},
    ...
    {id:"s5", name:"提问", cost:1, type:"study", damage:7, defense:0, gpa:3, image:"images/卡牌-学业/提问.png", effect:"reduceEnemyDamage3", desc:"造成7点伤害。敌人本回合伤害-3。"},
    {id:"s6", name:"蹭课大佬", cost:1, type:"study", damage:8, defense:0, gpa:2, image:"images/卡牌-学业/蹭课.png", effect:"discoverOtherType", desc:"造成8点伤害。发现一张其他流派牌。"},
    {id:"s7", name:"聚精会神", cost:1, type:"study", damage:0, defense:8, gpa:2, image:"images/卡牌-学业/聚精会神.png", desc:"获得8点效率。"},
    {id:"s8", name:"学术引用", cost:1, type:"study", damage:0, defense:0, gpa:2, image:"images/卡牌-学业/学术引用.png", effect:"copyLastStudyHalf", desc:"复制上张学业牌效果(伤害减半)。"},
    {id:"s9", name:"咖啡", cost:0, type:"study", damage:0, defense:0, gpa:0, image:"images/卡牌-学业/咖啡.png", effect:"gainEnergy1,selfDamage8", desc:"获得1精力。-8心态。"},
    {id:"s10", name:"答辩", cost:2, type:"study", damage:22, defense:0, gpa:8, image:"images/卡牌-学业/答辩.png", effect:"healOnKill5", desc:"造成22点伤害。若击败敌人，心态回5。"},
    // ===== 娱乐牌 =====
    ...
    {id:"f2", name:"犒劳自己", cost:0, type:"fun", damage:0, defense:0, gpa:0, image:"images/卡牌-娱乐/奖励自己.png", moneyCost:25, effect:"heal12,allDamage+2", desc:"花25生活费。+12心态，本回合伤害+2。"},
    {id:"f3", name:"重新开始？", cost:1, type:"fun", damage:0, defense:0, gpa:0, image:"images/卡牌-娱乐/重新.png", effect:"discardAllRedrawEqual,heal2", desc:"弃所有手牌重抽等量。+2心态。"},
    {id:"f4", name:"堵桥来", cost:2, type:"fun", damage:10, defense:0, gpa:0, image:"images/卡牌-娱乐/堵桥来.png", effect:"heal2,drawSocial", desc:"造成10伤害，+2心态，抽1张社交牌。"},
    {id:"f5", name:"网购", cost:0, type:"fun", damage:0, defense:0, gpa:0, image:"images/卡牌-娱乐/网购.png", moneyCost:15, effect:"randomTempItem", desc:"花15生活费。随机获得临时道具。"},
    {id:"f6", name:"校园墙对线", cost:1, type:"fun", damage:0, defense:0, gpa:0, image:"images/卡牌-娱乐/校园墙对线.png", effect:"weakEnemy", desc:"敌人下回合伤害降低50%。"},
    ...
    {id:"f8", name:"下周再说", cost:0, type:"fun", damage:0, defense:0, gpa:0, image:"images/卡牌-娱乐/下周再说.png", effect:"gainEnergy1,addAnxiety", desc:"获得1精力。牌组加1张焦虑。"},
    {id:"f9", name:"白日梦", cost:1, type:"fun", damage:0, defense:15, gpa:0, image:"images/卡牌-娱乐/白日梦.png", effect:"loseDefense5NextTurn", desc:"获得15点效率。下回合-5效率。"},
    ...
    // ===== 社交牌 =====
    {id:"so1", name:"菜菜捞捞", cost:1, type:"social", damage:0, defense:0, gpa:0, image:"images/卡牌-社交/菜菜捞捞.png", effect:"surviveLethalWith1hp", desc:"下次致死伤害保留1心态。"},
    {id:"so3", name:"义父！", cost:0, type:"social", damage:0, defense:0, gpa:0, image:"images/卡牌-社交/义父.png", moneyCost:20, effect:"gainEnergy1", desc:"花20生活费。+1精力。"},
    {id:"so4", name:"聚餐", cost:0, type:"social", damage:0, defense:0, gpa:0, image:"images/卡牌-社交/聚餐.png", moneyCost:25, effect:"next2SocialFree", desc:"花25生活费。下2张社交牌免费。"},
    {id:"so5", name:"代签", cost:0, type:"social", damage:10, defense:0, gpa:0, image:"images/卡牌-社交/代签.png", hidden:"noGpaThisBattle", desc:"造成10点伤害。"},
    {id:"so6", name:"我需要朋导！", cost:1, type:"social", damage:0, defense:0, gpa:1, image:"images/卡牌-社交/我需要朋导.png", effect:"addStudyCard0Cost", desc:"随机学业牌加入手牌(本回合0耗)。"},
    {id:"so7", name:"社团团建", cost:2, type:"social", damage:0, defense:0, gpa:-2, image:"images/卡牌-社交/社团团建.png", effect:"allCards+3permanent", desc:"所有手牌伤害/防御+3(本战斗)。"},
    // ===== 诅咒牌 =====
    {id:"c1", name:"过敏性鼻炎", cost:-1, type:"curse", damage:0, defense:0, gpa:0, image:"images/卡牌-诅咒/过敏性鼻炎.png", effect:"retain,firstCardCost+1Conditional", desc:"[保留]在手中时，每3回合让第一张牌精力消耗+1。"},
    {id:"c2", name:"帝王蟹（已废弃）", cost:-1, type:"curse", damage:0, defense:0, gpa:0, effect:"every2TurnsEnergy-1", desc:"[已废弃]此卡牌不应出现。"},
    {id:"c3", name:"昏昏欲睡", cost:-1, type:"curse", damage:0, defense:0, gpa:0, image:"images/卡牌-诅咒/昏昏欲睡.png", effect:"occupyHandSlot", desc:"占据手牌位，无任何作用。"},
    {id:"c4", name:"焦虑", cost:1, type:"curse", damage:0, defense:0, gpa:0, image:"images/卡牌-诅咒/焦虑.png", effect:"exhaust", desc:"[消耗]打出后移除。无正面效果。"}
];
...
const endings = {
    ...
    A: {condition:"gpa >= 4.5", rank:"A", title:"绩点战神：鼓楼卷王", desc:"虽然没有达到顶尖的5.0，但你依然是鼓楼校区传说级的存在。在这个「期末周」的战场上，你精准地收割了每一分。你的名字将随着那份4.5+的成绩单在表白墙上流传。"},
